...
x_dir = './dataset/VOC2012_train/JPEGImages/'
y_dir = './dataset/VOC2012_train/SegmentationClass/'
...
def get_data():
    trainval_file_names = np.loadtxt(
        './dataset/VOC2012_train/ImageSets/Segmentation/trainval.txt', dtype=np.str)
